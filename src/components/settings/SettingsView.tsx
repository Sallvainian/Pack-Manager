  ...
  return (
    <label className="flex items-center gap-3 py-2">
      ...
      <input
        ...
        className="h-8 w-24 rounded-control border border-border-strong bg-bg-raised px-2 text-right font-mono text-[13px] text-text-primary focus-visible:outline-2 focus-visible:outline-focus-ring focus-visible:outline-offset-1"
      />
    </label>
  );
}
              ...
              <div className="divide-y divide-border rounded-card border border-border bg-bg-surface px-4">
                ...
                <label className="flex items-center gap-3 py-2">
                  ...
                  <select
                    ...
                    className="h-8 rounded-control border border-border-strong bg-bg-raised px-2 text-[13px] text-text-primary focus-visible:outline-2 focus-visible:outline-focus-ring focus-visible:outline-offset-1"
                  >
                    {LOG_LEVELS.map((lvl) => (
