      ...
      {greedyRows.length > 0 && (
        <div className="border-t border-border">
          <button
            ...
            className="flex w-full items-center gap-2 px-3 py-2 text-left text-[13px] text-text-secondary hover:bg-bg-raised focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring"
          >
